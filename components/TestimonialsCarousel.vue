          ...
          <div class="py-12">
            <div class="relative">
              ...
              <img
                ...
                src="../assets/images/world-user-01.jpg"
                width="32"
                height="32"
                alt="User 01"
                data-aos="fade-up"
              ...
              <img
                ...
                src="../assets/images/world-user-02.jpg"
                width="48"
                height="48"
                alt="User 02"
                data-aos="fade-up"
              ...
              <img
                ...
                src="../assets/images/world-user-03.jpg"
                width="56"
                height="56"
                alt="User 02"
                data-aos="fade-up"
              ...
              <img
                ...
                src="../assets/images/world-user-04.jpg"
                width="72"
                height="72"
                alt="User 04"
                data-aos="fade-up"
              ...
              <img
                ...
                src="../assets/images/world-user-05.jpg"
                width="48"
                height="48"
                alt="User 05"
                data-aos="fade-up"
              ...
              <img
                ...
                src="../assets/images/world-user-06.jpg"
                width="56"
                height="56"
                alt="User 06"
                data-aos="fade-up"
              ...
              <img
                ...
                src="../assets/images/world-user-07.jpg"
                width="64"
                height="64"
                alt="User 07"
                data-aos="fade-up"
              ...
              <img
                ...
                src="../assets/images/world-user-08.jpg"
                width="40"
                height="40"
                alt="User 08"
                data-aos="fade-up"
              ...
              <template>
                ...
                >
                  ...
                  <div class="text-gray-700 font-medium mt-3">
                    <cite class="text-gray-400 not-italic">{{
                      item.name
                    }}</cite>
                    / <span class="text-amber-400">{{ item.role }}</span>
                  </div>
                </div>
              </template>
            </transition-group>

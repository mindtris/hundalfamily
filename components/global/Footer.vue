        ...
        <div class="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
          ...
          <div class="md:col-span-4 lg:col-span-5">
            <div class="mb-2">
              ...
              <router-link to="/" class="inline-block" aria-label="Cruip">
                <svg
                  class="w-8 h-8 fill-current text-purple-600"
                  viewBox="0 0 32 32"
          ...
          <div class="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
            ...
            <div class="text-sm">
              ...
              <ul>
                <li class="mb-1">
                  <router-link to="#" class="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out"
            ...
            <div class="text-sm">
              ...
              <ul>
                <li class="mb-1">
                  <router-link to="#" class="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out"
                    >Nostrud exercitation</router-link
                  >
                </li>
                <li class="mb-1">
                  <router-link to="#" class="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out"
                    >Visual mockups</router-link
                  >
                </li>
                <li class="mb-1">
                  <router-link to="#" class="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out"
            ...
            <div class="text-sm">
              ...
              <ul>
                <li class="mb-1">
                  <router-link to="#" class="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out"
                    >Consectetur adipiscing</router-link
                  >
                </li>
                <li class="mb-1">
                  <router-link to="#" class="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out"
                    >Labore et dolore</router-link
                  >
                </li>
                <li class="mb-1">
                  <router-link to="#" class="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out"

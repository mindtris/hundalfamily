        ...
        <div class="grid gap-20">
          ...
          <div class="md:grid md:grid-cols-12 md:gap-6 items-center">
            ...
            <div class="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1" data-aos="fade-up">
              <img class="max-w-full mx-auto md:max-w-none h-auto" src="../assets/images/features-03-image-01.png" width="540" height="405" alt="Features 01" />
            </div>
            <!-- Content -->
            <div class="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
              <div class="md:pr-4 lg:pr-12 xl:pr-16">
                <div class="font-architects-daughter text-xl text-amber-400 mb-2">More speed. Less spend</div>
          ...
          <div class="md:grid md:grid-cols-12 md:gap-6 items-center">
            ...
            <div class="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:rtl" data-aos="fade-up">
              <img class="max-w-full mx-auto md:max-w-none h-auto" src="../assets/images/features-03-image-02.png" width="540" height="405" alt="Features 02" />
            </div>
            <!-- Content -->
          ...
          <div class="md:grid md:grid-cols-12 md:gap-6 items-center">
            <!-- Image -->
            <div class="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1" data-aos="fade-up">
              <img class="max-w-full mx-auto md:max-w-none h-auto" src="../assets/images/features-03-image-03.png" width="540" height="405" alt="Features 03" />
            </div>
            <!-- Content -->
            <div class="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
              <div class="md:pr-4 lg:pr-12 xl:pr-16">

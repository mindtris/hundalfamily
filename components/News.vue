              ...
              <header>
                ...
                <div class="mb-3">
                  <ul class="flex flex-wrap text-xs font-medium -m-1">
                    <li class="m-1">
                      <a class="inline-flex text-center text-gray-100 py-1 px-3 rounded-full bg-amber-400 hover:bg-amber-400 transition duration-150 ease-in-out" href="#0">Product</a>
                    </li>
                    <li class="m-1">

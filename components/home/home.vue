    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 relative">
      ...
      <div v-if="landingContent" class="relative pt-32 pb-10 md:pt-40 md:pb-16">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16">
          ...
          <p class="text-xl text-primary-600 mb-8" data-aos="fade-up" data-aos-delay="200">
            {{ landingContent.description }}
          </p>
          <div class="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
            <div data-aos="fade-up" data-aos-delay="400">
              <a class="btn text-white bg-purple-600 hover:bg-purple-700 w-full mb-4 sm:w-auto sm:mb-0" href="#0"
                >Our Stories</a
              >
            </div>
            <div data-aos="fade-up" data-aos-delay="600">
              <a class="btn text-white bg-gray-700 hover:bg-gray-800 w-full sm:w-auto sm:ml-4" href="#0"
                >Our Projects</a
              >
            </div>
          </div>

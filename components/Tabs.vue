    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20 border-t border-gray-800">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12" data-aos-id-tabs>
          <h2 class="h2 mb-4" data-aos="fade-up" data-aos-anchor="[data-aos-id-tabs]">Integrated workflow designed for product teams</h2>
          <p class="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-tabs]">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit laborum — semper quis lectus nulla.</p>
        </div>
        ...
        <div>
          ...
          <div class="flex flex-wrap justify-center -m-2" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-tabs]">
            <button :class="{ 'opacity-50': tab !== '1' }" class="flex items-center font-medium py-2 px-4 m-2 bg-gray-800 rounded-full group transition duration-500" @click="tab = '1'">
              <svg class="w-4 h-4 fill-current text-amber-400 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="w-full" v-show="tab === '1'">
                <article class="relative max-w-md mx-auto md:max-w-none">
                  <figure class="md:absolute md:inset-y-0 md:right-0 md:w-1/2">
                    <img class="w-full h-full object-cover" src="../assets/images/tabs-image-01.jpg" width="516" height="387" alt="Tabs 01" />
                  </figure>
              ...
              <div class="w-full" v-show="tab === '2'">
                <article class="relative max-w-md mx-auto md:max-w-none">
                  <figure class="md:absolute md:inset-y-0 md:left-0 md:w-1/2">
                    <img class="w-full h-full object-cover" src="../assets/images/hero-image-01.jpg" width="516" height="387" alt="Tabs 02" />
                  </figure>
